...
Under the framework of ecosystem based management a number of studies have examined the correlation between metrics of community composition and a wide array of ecosystem disturbance regiems [@Fulton2005which; @rochet2010changes; @rice2000evaluating; Link citations etc].  We chose four univariate metrics composition metrics to describe and examine patterns of temporal variation within the northwestern Gulf demersal nekton community.  We calculated a 25 year time-series for Margalef's index (*D*), Pielou's eveness (*J*), and two of Hill's numbers *N1* and *N2* based on SEAMAP abundance data for our 64 taxonimc entities.  
