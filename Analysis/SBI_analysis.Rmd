...
plot1 <- ggplot(data=SBIDAT.ALLSPEC2, aes(x=YR, y=WmeanL)) + geom_line() + geom_point()
...
plot2 <- ggplot(data=SBIDAT.ALLSPEC3, aes(x=YR, y=WmeanL, group=bycatch, colour=bycatch)) + geom_line() + geom_point()
